    ...
    <header>
        <nav class="max-w-7xl flex items-center justify-between px-8 py-3 mx-auto" >
            ...
            <div class="hidden lg:flex lg:justify-center lg:gap-12 lg:items-center" >
                ...
                <ButtonPopoverCategories categoryLinks={categoryLinks} />
            ...
            <div class={`relative z-50 ${isOpen ? "" : "hidden"}`}>
                <Background color={className}>
                    <div class={`fixed inset-y-0 right-0 z-10 w-full px-8 py-4 overflow-y-auto sm:max-w-sm sm:ring-1 sm:ring-neutral/10 transform origin-right transition ease-in-out duration-300`}>
